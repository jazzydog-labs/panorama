...
class PanoramaCollector:
    ...
    def _load_repos_yaml(self) -> dict[str, Any]:
        ...
        try:
            with open(self.repos_yaml_path, encoding="utf-8") as f:
    ...
    def _format_file_section(self, file_path: Path, content: str, category: str) -> str:
        ...
        lang_map = {".md": "markdown", ".yaml": "yaml", ".yml": "yaml", ".json": "json", ".txt": "text"}
...
def main():
    ...
    parser.add_argument("--repos-yaml", default="config/repos.yaml", help="Path to repos.yaml configuration file")
